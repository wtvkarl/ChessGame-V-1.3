...
public class Rook extends Piece {
    ...
    public Rook(int boardIndex, String color) {
    ...
    public ArrayList<Move> getValidMoves(Square[] board) {
        ...
        for(int i = directionOffsetStartIndex; i < directionOffsets.length/2; i++){
